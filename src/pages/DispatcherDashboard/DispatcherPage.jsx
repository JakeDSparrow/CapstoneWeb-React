...
import ReportLogsView from './views/ReportLogsView';
import TeamOrganizerView from './views/TeamOrganizerView';
    ...
    <div className={`dispatcher-layout ${sidebarCollapsed ? 'sidebar-collapsed' : ''}`}>
      <div className="top-bar">
        ...
        <div className="user-menu">
          ...
          <button id="logout-btn" onClick={() => window.location.href = '/'}><i className="fas fa-sign-out-alt" /> Logout</button>
        </div>
      </div>
